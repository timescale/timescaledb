...
BEGIN
    ...
    FOR EACH ROW EXECUTE PROCEDURE _iobeamdb_internal.on_create_chunk_replica_node_index();
    ...
    FOR EACH ROW EXECUTE PROCEDURE _iobeamdb_internal.on_create_chunk_replica_node();
    ...
    FOR EACH ROW EXECUTE PROCEDURE _iobeamdb_internal.on_create_chunk();
    ...
    FOR EACH ROW EXECUTE PROCEDURE _iobeamdb_internal.on_create_cluster_user();
    ...
    FOR EACH ROW EXECUTE PROCEDURE _iobeamdb_internal.on_create_distinct_replica_node();
    ...
    FOR EACH ROW EXECUTE PROCEDURE _iobeamdb_internal.on_modify_column();
    ...
    FOR EACH ROW EXECUTE PROCEDURE _iobeamdb_internal.on_deleted_column();
    ...
    FOR EACH ROW EXECUTE PROCEDURE _iobeamdb_internal.on_create_hypertable_replica();
    ...
    FOR EACH ROW EXECUTE PROCEDURE _iobeamdb_internal.on_create_hypertable();
    ...
    FOR EACH ROW EXECUTE PROCEDURE _iobeamdb_internal.on_create_meta();
    ...
    FOR EACH ROW EXECUTE PROCEDURE _iobeamdb_internal.on_create_node();
    ...
    FOR EACH ROW EXECUTE PROCEDURE _iobeamdb_internal.on_create_partition_replica_table();
    ...
    FOR EACH ROW EXECUTE PROCEDURE _iobeamdb_internal.on_modify_hypertable_index();
    ...
    FOR EACH ROW EXECUTE PROCEDURE _iobeamdb_internal.on_deleted_hypertable_index();
    ...
    FOR EACH ROW EXECUTE PROCEDURE _iobeamdb_internal.on_deleted_hypertable();
