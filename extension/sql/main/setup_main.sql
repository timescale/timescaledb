...
BEGIN
    ...
    CREATE TRIGGER trigger_main_on_change_chunk_replica_node_index AFTER INSERT OR UPDATE OR DELETE ON _iobeamdb_catalog.chunk_replica_node_index
    ...
    CREATE TRIGGER trigger_main_on_change_chunk_replica_node AFTER INSERT OR UPDATE OR DELETE ON _iobeamdb_catalog.chunk_replica_node
    ...
    CREATE TRIGGER trigger_main_on_change_chunk AFTER INSERT OR UPDATE OR DELETE ON _iobeamdb_catalog.chunk
    ...
    CREATE TRIGGER trigger_main_on_change_cluster_user AFTER INSERT OR UPDATE OR DELETE ON _iobeamdb_catalog.cluster_user
    ...
    CREATE TRIGGER trigger_main_on_change_distinct_replica_node AFTER INSERT OR UPDATE ON _iobeamdb_catalog.distinct_replica_node
    ...
    CREATE TRIGGER trigger_main_on_change_column AFTER INSERT OR UPDATE OR DELETE ON _iobeamdb_catalog.hypertable_column
    ...
    CREATE TRIGGER trigger_main_on_change_deleted_column AFTER INSERT OR UPDATE OR DELETE ON _iobeamdb_catalog.deleted_hypertable_column
    ...
    CREATE TRIGGER trigger_main_on_change_hypertable_replica AFTER INSERT OR UPDATE ON _iobeamdb_catalog.hypertable_replica
    ...
    CREATE TRIGGER trigger_1_main_on_change_hypertable AFTER INSERT OR UPDATE ON _iobeamdb_catalog.hypertable
    ...
    CREATE TRIGGER trigger_main_on_change_meta AFTER INSERT OR UPDATE OR DELETE ON _iobeamdb_catalog.meta
    ...
    CREATE TRIGGER trigger_main_on_change_node AFTER INSERT OR UPDATE OR DELETE ON _iobeamdb_catalog.node
    ...
    CREATE TRIGGER trigger_main_on_change_partition_replica_table AFTER INSERT OR UPDATE ON _iobeamdb_catalog.partition_replica
    ...
    CREATE TRIGGER trigger_main_on_change_hypertable_index AFTER INSERT OR UPDATE ON _iobeamdb_catalog.hypertable_index
    ...
    CREATE TRIGGER trigger_main_on_change_deleted_hypertable_index AFTER INSERT OR UPDATE OR DELETE ON _iobeamdb_catalog.deleted_hypertable_index
    ...
    CREATE TRIGGER trigger_on_change_deleted_hypertable AFTER INSERT OR UPDATE OR DELETE ON _iobeamdb_catalog.deleted_hypertable
