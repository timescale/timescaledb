...
*/
SELECT _sysinternal.murmur3_hash_string('', 1 :: INT4) INTO hash_value;
...
SELECT _sysinternal.murmur3_hash_string('dev1', 1 :: INT4) INTO hash_value;
...
SELECT _sysinternal.murmur3_hash_string('longlonglonglongpartitionkey', 1 :: INT4) INTO hash_value;
