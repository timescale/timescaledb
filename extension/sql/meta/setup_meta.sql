...
BEGIN
    ...
    CREATE TRIGGER trigger_meta_on_change_chunk_replica_node AFTER INSERT OR UPDATE ON _iobeamdb_catalog.chunk_replica_node
    ...
    CREATE TRIGGER trigger_meta_on_change_chunk AFTER INSERT OR UPDATE OR DELETE ON _iobeamdb_catalog.chunk
    ...
    CREATE TRIGGER trigger_2_meta_change_hypertable AFTER INSERT OR UPDATE ON _iobeamdb_catalog.hypertable
    ...
    CREATE TRIGGER trigger_meta_change_node BEFORE INSERT OR UPDATE OR DELETE ON _iobeamdb_catalog.node
    ...
    CREATE TRIGGER trigger_meta_change_partition AFTER INSERT OR UPDATE ON _iobeamdb_catalog.partition
