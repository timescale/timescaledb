...
CREATE OR REPLACE PROCEDURE _timescaledb_functions.policy_move_hypertable_invalidations(job_id INTEGER, config JSONB)
AS '@MODULE_PATHNAME@', 'ts_policy_move_hyper_inval_proc'
LANGUAGE C;

CREATE OR REPLACE FUNCTION _timescaledb_functions.policy_move_hypertable_invalidations_check(config JSONB)
RETURNS void AS '@MODULE_PATHNAME@', 'ts_policy_move_hyper_inval_check'
LANGUAGE C;
