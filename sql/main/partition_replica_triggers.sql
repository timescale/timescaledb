CREATE OR REPLACE FUNCTION _timescaledb_internal.on_change_partition_replica_table()
    RETURNS TRIGGER LANGUAGE PLPGSQL AS
$BODY$
BEGIN
    IF TG_OP = 'INSERT' THEN
        PERFORM _timescaledb_internal.create_data_partition_table(
        ...
        CROSS JOIN _timescaledb_catalog.partition p
