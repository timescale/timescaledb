-- This migration script goes from 0.6.1->0.7.1 and bypasses 0.7.0
-- because the migration script 0.6.1->0.7.0 had bugs.
--
-- The first ~half of this file contains a modified version of 0.6.1->0.7.0
-- that does not have the bug. The second ~half of this is a modified version
...
-- !!!!! THIS IS WHERE THE MODIFIED 0.7.0 -> 0.7.1 BEGINS !!!!! --
