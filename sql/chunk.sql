...
-- TODO Nothing to do with chunks; move out.
CREATE OR REPLACE FUNCTION _timescaledb_internal.copy_constraints(
	src_table REGCLASS,
	dst_table REGCLASS)
RETURNS VOID
AS '@MODULE_PATHNAME@', 'ts_copy_constraints' LANGUAGE C VOLATILE;
