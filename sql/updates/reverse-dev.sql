...
DROP FUNCTION IF EXISTS @extschema@.to_uuidv7(timestamptz, boolean);
DROP FUNCTION IF EXISTS @extschema@.to_uuidv7_zeroed(timestamptz);
DROP FUNCTION IF EXISTS @extschema@.to_timestamp(uuid);
DROP FUNCTION IF EXISTS @extschema@.to_timestamp_micros(uuid);
