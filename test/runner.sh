...
TEST_ROLE_DEFAULT_CLUSTER_USER_2=${TEST_ROLE_DEFAULT_CLUSTER_USER_2:-default_cluster_user}
TEST_ROLE_DEFAULT_CLUSTER_USER_2_PASS=${TEST_ROLE_DEFAULT_CLUSTER_USER_2_PASS:-pass}
...
if [[ ! -f ${TEST_OUTPUT_DIR}/.pg_init ]]; then
    ...
    ALTER USER ${TEST_ROLE_DEFAULT_CLUSTER_USER_2} WITH CREATEDB PASSWORD '${TEST_ROLE_DEFAULT_CLUSTER_USER_2_PASS}';
EOF
...
${PSQL} -U ${TEST_PGUSER} \
     ...
     -v ROLE_DEFAULT_CLUSTER_USER_2=${TEST_ROLE_DEFAULT_CLUSTER_USER_2} \
     -v ROLE_DEFAULT_CLUSTER_USER_2_PASS=${TEST_ROLE_DEFAULT_CLUSTER_USER_2_PASS} \
