...
SELECT _timescaledb_internal.time_to_internal(TIMESTAMPTZ '2017-02-07 15:09:36.236538+00');

-- For timestamps, BIGINT MAX represents +Infinity and BIGINT MIN
-- -Infinity. We keep this notion for UNIX epoch time:
SELECT _timescaledb_internal.time_to_internal(TIMESTAMPTZ '+infinity');
...
SELECT _timescaledb_internal.time_to_internal(TIMESTAMPTZ '4714-11-24 00:00:00+00 BC');

-- Going beyond lower bound on date should return out-of-range
SELECT _timescaledb_internal.time_to_internal(TIMESTAMPTZ '4714-11-23 23:59:59.999999+00 BC');
...
SELECT _timescaledb_internal.time_to_internal(TIMESTAMPTZ '294276-12-31 23:59:59.999999+00');
...
SELECT _timescaledb_internal.time_to_internal(TIMESTAMPTZ '294247-01-01 23:59:59.999999');

-- Adding one microsecond should take us out-of-range again
SELECT timestamp '294247-01-01 23:59:59.999999' + interval '1 us';
SELECT _timescaledb_internal.time_to_internal(timestamp '294247-01-01 23:59:59.999999' + interval '1 us');
