...
-- This must agree with HypertableRestrictInfo about which quals
-- are dimension restrictions -- otherwise quals get stripped that
-- HRI never accounted for, producing wrong results.

\c :TEST_DBNAME :ROLE_SUPERUSER

-- Regression test for github issue #9387: ::date cast on timestamptz
-- column uses a STABLE cross-type operator (timestamptz_lt_date).
-- HRI skips STABLE quals, but filter_baserestrictions was removing them
-- anyway, causing extra rows to be returned.
