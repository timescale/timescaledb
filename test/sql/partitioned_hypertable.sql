...
CREATE TABLE invalid(time TEXT NOT NULL, value FLOAT) WITH (timescaledb.hypertable, timescaledb.partition_column='time');
CREATE TABLE invalid(time TEXT NOT NULL, value FLOAT) WITH (timescaledb.hypertable);
\set ON_ERROR_STOP 1
