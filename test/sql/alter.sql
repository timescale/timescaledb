...
-- dropping a the partitioning dimension's chunk constraint should fail
ALTER TABLE _timescaledb_internal._hyper_1_1_chunk DROP CONSTRAINT constraint_1;

-- renaming a partitioning dimension's chunk constraint should fail
ALTER TABLE _timescaledb_internal._hyper_1_1_chunk RENAME CONSTRAINT constraint_1 TO foobar;
\set ON_ERROR_STOP 1
