...
If you are using this feature with **hierarchical** continous aggregates, please [create a new policy](https://docs.tigerdata.com/use-timescale/latest/continuous-aggregates/refresh-policies/#change-the-refresh-policy) for the full range you want to refresh and [disable the existing policy jobs](https://docs.tigerdata.com/api/latest/jobs-automation/alter_job/#samples), of the continuous aggregate as following:
```
--- Create new policy for hierarchical continous aggregate
