...
CROSSMODULE_WRAPPER(rapid_raccoon_compressor_append);
CROSSMODULE_WRAPPER(rapid_raccoon_compressor_finish);
...
TSDLLEXPORT CrossModuleFunctions ts_cm_functions_default = {
	...
	.rapid_raccoon_compressor_append = error_no_default_fn_pg_community,
	.rapid_raccoon_compressor_finish = error_no_default_fn_pg_community,
