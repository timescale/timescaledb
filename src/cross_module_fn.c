...
CROSSMODULE_WRAPPER(compressed_column_metadata_name);
CROSSMODULE_WRAPPER(rename_compressed_column);
...
TSDLLEXPORT CrossModuleFunctions ts_cm_functions_default = {
	...
	.compressed_column_metadata_name = error_no_default_fn_pg_community,
	.rename_compressed_column = error_no_default_fn_pg_community,
