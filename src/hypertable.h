...
extern Oid ts_hypertable_id_to_relid_with_snapshot(int32 hypertable_id, Snapshot snapshot,
												   bool return_invalid);
...
extern TSDLLEXPORT bool ts_hypertable_has_noncontiguous_osm_chunk(const Hypertable *ht);
