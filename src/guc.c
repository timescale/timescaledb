...
TSDLLEXPORT bool ts_guc_enable_rapid_raccoon_compression = false;
...
_guc_init(void)
{
	...
	DefineCustomBoolVariable(MAKE_EXTOPTION("enable_rapid_raccoon_compression"),
							 "Enable rapid raccoon integer compression functionality",
							 "Enable rapid raccoon integer compression",
							 &ts_guc_enable_rapid_raccoon_compression,
							 false,
							 PGC_USERSET,
							 0,
							 NULL,
