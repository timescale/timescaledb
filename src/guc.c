...
TSDLLEXPORT bool ts_guc_enable_direct_compress_segmentby = true;
...
_guc_init(void)
{
	...
	DefineCustomBoolVariable(MAKE_EXTOPTION("enable_direct_compress_segmentby"),
							 ...
							 &ts_guc_enable_direct_compress_segmentby,
							 true,
							 PGC_USERSET,
							 0,
							 NULL,
