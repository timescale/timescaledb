...
static FuncInfo funcinfo[] = {
	...
	/* gapfill marker functions */
	{
		...
		.funcname = "locf",
		.nargs = 3,
		.arg_types = { ANYELEMENTOID, ANYELEMENTOID, BOOLOID },
		.group_estimate = NULL,
		.sort_transform = NULL,
	},
	{
		...
		.nargs = 3,
		.arg_types = { INT2OID, RECORDOID, RECORDOID },
		.group_estimate = NULL,
		.sort_transform = NULL,
	},
	{
		...
		.funcname = "interpolate",
		.nargs = 3,
		.arg_types = { INT4OID, RECORDOID, RECORDOID },
		.group_estimate = NULL,
		.sort_transform = NULL,
	},
	{
		...
		.funcname = "interpolate",
		.nargs = 3,
		.arg_types = { INT8OID, RECORDOID, RECORDOID },
		.group_estimate = NULL,
		.sort_transform = NULL,
	},
	{
		...
		.funcname = "interpolate",
		.nargs = 3,
		.arg_types = { FLOAT4OID, RECORDOID, RECORDOID },
		.group_estimate = NULL,
		.sort_transform = NULL,
	},
	{
		...
		.funcname = "interpolate",
		.nargs = 3,
		.arg_types = { FLOAT8OID, RECORDOID, RECORDOID },
		.group_estimate = NULL,
		.sort_transform = NULL,
	},
