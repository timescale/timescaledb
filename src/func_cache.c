...
static FuncInfo funcinfo[] = {
	...
	},
	{
		...
		.nargs = 6,
		.arg_types = { INTERVALOID, TIMESTAMPOID, TIMESTAMPOID, TIMESTAMPOID, TIMESTAMPOID, INTERVALOID },
		.group_estimate = time_bucket_group_estimate,
		.sort_transform = time_bucket_gapfill_sort_transform,
	},
	{
		/* time_bucket_gapfill(INTERVAL, TIMESTAMPTZ, TIMESTAMPTZ, TIMESTAMPTZ, TIMESTAMPTZ, INTERVAL) */
		.origin = ORIGIN_TIMESCALE,
		.is_bucketing_func = true,
		.allowed_in_cagg_definition = false,
		.funcname = "time_bucket_gapfill",
		.nargs = 6,
		.arg_types = { INTERVALOID, TIMESTAMPTZOID, TIMESTAMPTZOID, TIMESTAMPTZOID, TIMESTAMPTZOID, INTERVALOID },
		.group_estimate = time_bucket_group_estimate,
		.sort_transform = time_bucket_gapfill_sort_transform,
	},
	{
		/* time_bucket_gapfill(INTERVAL, TIMESTAMPTZ, TEXT, TIMESTAMPTZ, TIMESTAMPTZ, TIMESTAMPTZ, INTERVAL) */
		.origin = ORIGIN_TIMESCALE,
		.is_bucketing_func = true,
		.allowed_in_cagg_definition = false,
		.funcname = "time_bucket_gapfill",
		.nargs = 7,
		.arg_types = { INTERVALOID, TIMESTAMPTZOID, TEXTOID, TIMESTAMPTZOID, TIMESTAMPTZOID, TIMESTAMPTZOID, INTERVALOID },
		.group_estimate = time_bucket_group_estimate,
		.sort_transform = time_bucket_gapfill_sort_transform,
	},
	{
