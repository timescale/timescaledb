...
extern const char *SparseIndexTypeNames[];
extern const char *SparseIndexCommonKeys[];
...
TSDLLEXPORT void ts_compression_settings_rename_column_cascade(Oid parent_relid, const char *old,
															   const char *new);
TSDLLEXPORT bool ts_contains_sparse_index_config(CompressionSettings *settings, const char *attname,
