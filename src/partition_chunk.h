...
#define is_partitioning_allowed(relid) (ts_guc_enable_partitioned_hypertables && (get_rel_relkind(relid) == RELKIND_PARTITIONED_TABLE))
...
extern void ts_partition_chunk_attach(const Hypertable *ht, const Chunk *chunk);
