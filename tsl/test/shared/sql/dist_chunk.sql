...
-- Test function _timescaledb_functions.create_chunk_replica_table
\set ON_ERROR_STOP 0
SELECT _timescaledb_functions.create_chunk_replica_table(NULL, 'data_node_1');
SELECT _timescaledb_functions.create_chunk_replica_table('_timescaledb_internal._dist_hyper_15_67_chunk', NULL);
SELECT _timescaledb_functions.create_chunk_replica_table(1234, 'data_node_1');
SELECT _timescaledb_functions.create_chunk_replica_table('metrics_int', 'data_node_1');
SELECT _timescaledb_functions.create_chunk_replica_table('conditions', 'data_node_1');
SELECT _timescaledb_functions.create_chunk_replica_table('_timescaledb_internal._hyper_10_51_chunk', 'data_node_1');
SELECT _timescaledb_functions.create_chunk_replica_table('_timescaledb_internal._dist_hyper_15_67_chunk', 'data_node_2');
SELECT _timescaledb_functions.create_chunk_replica_table('_timescaledb_internal._dist_hyper_15_27_chunk', 'data_node_2');
SELECT _timescaledb_functions.create_chunk_replica_table('_timescaledb_internal._dist_hyper_15_67_chunk', 'data_node_4');
BEGIN READ ONLY;
SELECT _timescaledb_functions.create_chunk_replica_table('_timescaledb_internal._dist_hyper_15_67_chunk', 'data_node_3');
COMMIT;
\set ON_ERROR_STOP 1

SELECT _timescaledb_functions.create_chunk_replica_table('_timescaledb_internal._dist_hyper_15_67_chunk', 'data_node_1');
...
SELECT _timescaledb_functions.create_chunk_replica_table('_timescaledb_internal._dist_hyper_15_70_chunk', 'data_node_2');
...
-- Test function _timescaledb_functions.chunk_drop_replica
-- Sanity checking of the chunk_drop_replica API

\set ON_ERROR_STOP 0
-- Check that it doesn't work in a read only transaction
SET default_transaction_read_only TO on;
SELECT _timescaledb_functions.chunk_drop_replica(NULL, NULL);
...
SELECT _timescaledb_functions.chunk_drop_replica('public.metrics', NULL);

-- Specifying regular hypertable chunk on a proper data node errors out
SELECT _timescaledb_functions.chunk_drop_replica('_timescaledb_internal._hyper_1_1_chunk', 'data_node_1');

-- Specifying non-existent chunk on a proper data node errors out
SELECT _timescaledb_functions.chunk_drop_replica('_timescaledb_internal._dist_hyper_700_38_chunk', 'data_node_1');
...
SELECT _timescaledb_functions.chunk_drop_replica(:'CHUNK_NAME', 'bad_node');
...
SELECT _timescaledb_functions.chunk_drop_replica(:'CHUNK_NAME', NULL);
...
SELECT _timescaledb_functions.chunk_drop_replica(:'CHUNK_NAME', :'PRIMARY_CHUNK_NODE');
...
SELECT _timescaledb_functions.chunk_drop_replica(:'CHUNK_NAME', 'data_node_2');
