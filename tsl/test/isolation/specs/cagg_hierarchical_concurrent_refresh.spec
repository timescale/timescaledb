...
step "chk_pending_ranges"
{
    SELECT ca.user_view_name AS cagg,
           _timescaledb_functions.to_timestamp(lowest_modified_value) AS lowest,
           _timescaledb_functions.to_timestamp(greatest_modified_value) AS greatest
    FROM _timescaledb_catalog.continuous_aggs_materialization_ranges l
    JOIN _timescaledb_catalog.continuous_agg ca ON ca.mat_hypertable_id = l.materialization_id
    ORDER BY 1, 2, 3;
}
step "chk_cagg_6h"
...
permutation "chk_hyper_invals" "WP_after_enable" "L1_refresh_jan1" "chk_pending_ranges" "WP_after_release" "chk_hyper_invals" "WP_after_enable" "L2_refresh_jan1" "chk_pending_ranges"  "WP_after_release" "chk_cagg_6h" "chk_cagg_1d" "chk_6h_consistency" "chk_1d_consistency"
...
permutation "WP_before_enable" "WP_after_enable" "chk_hyper_invals" "L1_refresh_jan1" "insert_ht" "chk_mat_invals" "L1b_refresh_jan1_2" "chk_mat_invals" "chk_pending_ranges" "WP_before_release" "chk_pending_ranges" "WP_after_release" "chk_mat_invals" "chk_pending_ranges" "L2_refresh_full" "chk_6h_consistency" "chk_1d_consistency"
...
permutation "L1_refresh_full" "chk_1d_consistency" "WP_before_enable" "chk_hyper_invals" "L2_refresh_jan1" "insert_ht" "L1_refresh_full" "lock_L2_source" "WP_before_release"  "L2b_refresh_jan1_2" "WP_after_enable" "unlock_L2_source" "chk_pending_ranges" "WP_after_release" "chk_pending_ranges" "chk_cagg_1d" "chk_1d_consistency"

# Non-overlapping concurrent refresh on L1. Both refreshes should succeed.
permutation "WP_before_enable" "WP_after_enable" "chk_hyper_invals" "L1_refresh_jan1" "insert_ht" "chk_mat_invals" "L1b_refresh_jan3" "chk_mat_invals" "chk_pending_ranges" "WP_before_release" "chk_pending_ranges" "WP_after_release" "chk_mat_invals" "chk_pending_ranges" "L2_refresh_full" "chk_6h_consistency" "chk_1d_consistency"

# Non-overlapping concurrent refresh on L2. Both refreshes should succeed.
permutation "L1_refresh_full" "chk_1d_consistency" "WP_before_enable" "chk_hyper_invals" "L2_refresh_jan1" "insert_ht" "L1_refresh_full" "lock_L2_source" "WP_before_release"  "L2b_refresh_jan3" "WP_after_enable" "unlock_L2_source" "chk_pending_ranges" "WP_after_release" "chk_pending_ranges" "chk_cagg_1d" "chk_1d_consistency"
