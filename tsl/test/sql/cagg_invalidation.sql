...
CALL refresh_continuous_aggregate('tenant_copy_daily', NULL, '2025-05-01 00:00+00');
...
-- expect invalidation entry for 2023 corresponding to COPY
-- -infinity/-infinity row is residual outside refreshed window from initial refresh
