...
SELECT _timescaledb_functions.cagg_get_groupingcols('metrics_by_hour'::regclass); 
SELECT _timescaledb_functions.cagg_get_groupingcols('metrics_by_month'::regclass);
...
SELECT unnest(_timescaledb_functions.cagg_get_groupingcols('cagg_test_groupingcols'::regclass));
