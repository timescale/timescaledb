...
INSERT INTO metrics VALUES
('2025-01-01 03:00:00 PST', 'd1', 'A', 11.0),
('2025-01-01 01:00:00 PST', 'd1', 'A', 21.0),
('2025-01-01 02:00:00 PST', 'd1', 'A', 15.1),
('2025-01-01 03:30:00 PST', 'd1', 'B', 5.1),
('2025-01-01 01:30:00 PST', 'd1', 'B', 25.1),
('2025-01-01 02:30:00 PST', 'd1', 'B', 31.0),
('2025-01-01 03:00:00 PST', 'd2', 'A', 11.0),
('2025-01-01 01:00:00 PST', 'd2', 'A', 21.0),
('2025-01-01 02:00:00 PST', 'd2', 'A', 15.2),
('2025-01-01 03:30:00 PST', 'd2', 'C', 5.3),
('2025-01-01 01:30:00 PST', 'd2', 'C', 25.3),
('2025-01-01 02:30:00 PST', 'd2', 'C', 32.0);
...
SET timescaledb.enable_compressed_unordered_sort = 0;
-- Cannot use SkipScan on unordered chunks with distinct segmentby columns with the flag off
...
:PREFIX select device, sensor, avg(value) from metrics where time > '2025-01-01 01:00:00 PST' group by device, sensor order by 1,2;
select device, sensor, avg(value) from metrics where time > '2025-01-01 01:00:00 PST' group by device, sensor order by 1,2;
...
:PREFIX select time, avg(value) from metrics2 where time > '2025-01-01 01:00:00 PST' group by time order by time DESC;
select time, avg(value) from metrics2  where time > '2025-01-01 01:00:00 PST' group by time order by time DESC;
