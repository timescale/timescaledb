...
SELECT
    ...
    '{}'::jsonb as data
FROM generate_series(now() - interval '3 months', now(), interval '15 minutes') as ts;
...
FROM _timescaledb_internal.bgw_job_stat_history
WHERE
execution_finish > now() - interval '1 month';
...
(job_id, pid, succeeded, execution_start, execution_finish, data)
VALUES
(301, 3001, true, now() - interval '2 months', now() - interval '2 months' + interval '5 minutes', '{}'),
(302, 3002, true, now() - interval '6 weeks', now() - interval '6 weeks' + interval '5 minutes', '{}'),
(303, 3003, true, now() - interval '1 month', now() - interval '1 month' + interval '5 minutes', '{}'),
...
(job_id, pid, succeeded, execution_start, execution_finish, data)
VALUES
(401, 4001, true, now() - interval '3 months', now() - interval '3 months' + interval '5 minutes', '{}'),
(402, 4002, true, now() - interval '2 months', now() - interval '2 months' + interval '5 minutes', '{}'),
(403, 4003, true, now() - interval '6 weeks', now() - interval '6 weeks' + interval '5 minutes', '{}'),
(401, 4001, true, now() - interval '1 month', now() - interval '1 month' + interval '5 minutes', '{}'),
...
SELECT
    ...
    ts + interval '5 minutes' as execution_finish,
    '{}'::jsonb as data
FROM generate_series(now() - interval '2 months', now() - interval '1 week', interval '1 week') as ts;
...
(job_id, pid, succeeded, execution_start, execution_finish, data)
VALUES
(601, 6001, true, now() - interval '3 months', now() - interval '3 months' + interval '5 minutes', '{}'),
(602, 6002, true, now() - interval '2 months', now() - interval '2 months' + interval '5 minutes', '{}'),
...
SELECT _timescaledb_functions.job_history_bsearch(now() - interval '1 month');

-- Single element
INSERT INTO _timescaledb_internal.bgw_job_stat_history
(id, job_id, pid, succeeded, execution_start, execution_finish, data)
VALUES
(5, 601, 6001, true, now() - interval '2 weeks', now() - interval '2 weeks' + interval '5 minutes', '{}');

-- Return the single element
SELECT _timescaledb_functions.job_history_bsearch(now() - interval '1 month');

-- Return NULL
SELECT _timescaledb_functions.job_history_bsearch(now() - interval '1 week');
...
(id, job_id, pid, succeeded, execution_start, execution_finish, data)
VALUES
(5, 701, 7001, true, now() - interval '3 weeks', now() - interval '3 weeks' + interval '5 minutes', '{}'),
(6, 702, 7002, true, now() - interval '1 week', now() - interval '1 week' + interval '5 minutes', '{}');

-- Returns the first element
SELECT _timescaledb_functions.job_history_bsearch(now() - interval '1 month');
-- Returns the second element
SELECT _timescaledb_functions.job_history_bsearch(now() - interval '2 weeks');
-- Returns NULL
SELECT _timescaledb_functions.job_history_bsearch(now() - interval '3 days');
...
(id, job_id, pid, succeeded, execution_start, execution_finish, data)
VALUES
(5, 801, 8001, true, now() - interval '5 weeks', now() - interval '5 weeks' + interval '5 minutes', '{}'),
(6, 802, 8002, true, now() - interval '4 weeks', now() - interval '4 weeks' + interval '5 minutes', '{}'),
(7, 803, 8003, true, now() - interval '3 weeks', now() - interval '3 weeks' + interval '5 minutes', '{}'),
(8, 804, 8004, true, now() - interval '2 weeks', now() - interval '2 weeks' + interval '5 minutes', '{}'),
(9, 805, 8005, true, now() - interval '1 week', now() - interval '1 week' + interval '5 minutes', '{}');

-- Returns the first element
SELECT _timescaledb_functions.job_history_bsearch(now() - interval '6 weeks');
-- Returns the middle element
SELECT _timescaledb_functions.job_history_bsearch(now() - interval '3 weeks');
-- Returns one after the middle element
SELECT _timescaledb_functions.job_history_bsearch(now() - interval '2 weeks 3 days');
-- Returns NULL
SELECT _timescaledb_functions.job_history_bsearch(now() - interval '2 days');
...
(id, job_id, pid, succeeded, execution_start, execution_finish, data)
VALUES
(5, 902, 9002, true, now() - interval '5 weeks', now() - interval '5 weeks' + interval '5 minutes', '{}'),
(6, 903, 9003, true, now() - interval '4 weeks', now() - interval '4 weeks' + interval '5 minutes', '{}'),
(7, 904, 9004, true, now() - interval '3 weeks', now() - interval '3 weeks' + interval '5 minutes', '{}'),
(8, 905, 9005, true, now() - interval '2 weeks', now() - interval '2 weeks' + interval '5 minutes', '{}'),
(9, 906, 9006, true, now() - interval '1 week', now() - interval '1 week' + interval '5 minutes', '{}'),
(10, 907, 9007, true, now() - interval '3 days', now() - interval '3 days' + interval '5 minutes', '{}');
...
(id, job_id, pid, succeeded, execution_start, execution_finish, data)
VALUES
(10, 1001, 10001, true, now() - interval '5 weeks', now() - interval '5 weeks' + interval '5 minutes', '{}'),
(11, 1002, 10002, true, now() - interval '4 weeks', now() - interval '4 weeks' + interval '5 minutes', '{}'),
(13, 1003, 10003, true, now() - interval '3 weeks', now() - interval '3 weeks' + interval '5 minutes', '{}'),
(15, 1004, 10004, true, now() - interval '2 weeks', now() - interval '2 weeks' + interval '5 minutes', '{}'),
(16, 1005, 10005, true, now() - interval '1 week', now() - interval '1 week' + interval '5 minutes', '{}');

-- Returns id before the gap
SELECT _timescaledb_functions.job_history_bsearch(now() - interval '3 weeks 3 days') AS result_gap_trigger1;
-- Returns id after the gap
SELECT _timescaledb_functions.job_history_bsearch(now() - interval '2 weeks 3 days') AS result_gap_trigger2;
-- Returns second element
SELECT _timescaledb_functions.job_history_bsearch(now() - interval '4 weeks 3 days') AS result_gap_trigger3;
