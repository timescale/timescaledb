...
SELECT * FROM ht_settings;
SELECT * FROM chunk_settings;
ALTER TABLE metrics SET (timescaledb.compress_segmentby='d2', timescaledb.index='bloom(value)');
...
ALTER TABLE metrics SET (timescaledb.compress_segmentby='d2', timescaledb.index='');
