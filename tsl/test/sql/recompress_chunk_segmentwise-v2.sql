...
-- case10: gaps between sequence numbers are filled up
-- Number of segments decompressed is 1
BEGIN;
...
SELECT name, _ts_meta_sequence_num, _ts_meta_count, _ts_meta_min_1, _ts_meta_max_1
    FROM _timescaledb_internal.compress_hyper_4_9_chunk ORDER BY 1, 2;

set client_min_messages TO LOG;
CALL recompress_chunk('_timescaledb_internal._hyper_3_8_chunk');
RESET client_min_messages;
...
-- check metadata
SELECT a, c, _ts_meta_sequence_num, _ts_meta_count, _ts_meta_min_1, _ts_meta_max_1 FROM _timescaledb_internal.compress_hyper_6_69_chunk ORDER BY 1, 2;
...
set client_min_messages TO LOG;
CALL recompress_chunk('_timescaledb_internal._hyper_5_62_chunk');
RESET client_min_messages;
