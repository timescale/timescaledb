...
CREATE TABLE test1 ("Time" timestamptz NOT NULL, i integer, value integer);
...
CREATE TABLE test2 ("Time" timestamptz NOT NULL, i integer, loc integer NOT NULL, value integer);
...
CREATE TABLE test3 ("Time" timestamptz NOT NULL, i integer, loc integer NOT NULL, value integer);
...
CREATE TABLE test4 ("Time" timestamptz NOT NULL, i integer, loc integer NOT NULL, value integer);
...
CREATE TABLE test5 ("Time" timestamptz NOT NULL, i integer, value integer);
...
CREATE TABLE test6 ("Time" timestamptz NOT NULL, i integer, value integer);
...
CREATE TABLE test7 ("Time" timestamptz NOT NULL, i integer, j integer NOT NULL, k integer, value integer);
...
CREATE TABLE test10 ("Time" timestamptz NOT NULL, i integer, value integer);
...
CREATE TABLE test_defaults ("Time" timestamptz NOT NULL, i integer, value integer) WITH (tsdb.hypertable, tsdb.chunk_interval='1 hour');
