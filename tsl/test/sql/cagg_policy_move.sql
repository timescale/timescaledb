...
\set ON_ERROR_STOP 0
CALL add_move_hypertable_invalidations_policy('measurements',
...
\set ON_ERROR_STOP 0
CALL add_move_hypertable_invalidations_policy('conditions_10',
     schedule_interval => '1 minute'::interval);
\set ON_ERROR_STOP 1

CALL add_move_hypertable_invalidations_policy('conditions',
    schedule_interval => '1 minute'::interval
);
...
SELECT application_name, owner,
       ...
       schedule_interval, hypertable_id, config
...
CALL remove_move_hypertable_invalidations_policy('conditions');
\set ON_ERROR_STOP 1
...
\set ON_ERROR_STOP 0
CALL remove_move_hypertable_invalidations_policy('conditions_10');
CALL remove_move_hypertable_invalidations_policy('conditions', if_exists => false);
CALL remove_move_hypertable_invalidations_policy('conditions', if_exists => true);
\set ON_ERROR_STOP 1
