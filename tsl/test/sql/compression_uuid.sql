...
CREATE TABLE base_uuids (i int, u uuid);
INSERT INTO base_uuids (i, u) VALUES
...
UPDATE t SET u = (select u from base_uuids where i = ts) where ts <= 100;

-- set data to be compressed with the dictionary compressor
UPDATE t SET u = (select u from base_uuids where i = ts%100) where ts > 1000 and ts <= 2000;
...
INSERT INTO mixed_compressed SELECT i, u FROM base_uuids;
INSERT INTO mixed_compressed SELECT i+100 as i, NULL as u FROM base_uuids;
...
SET timescaledb.enable_uuid_compression = on;
INSERT INTO mixed_compressed SELECT i+1000 as i, u FROM base_uuids;
INSERT INTO mixed_compressed SELECT i+1100 as i, NULL as u FROM base_uuids;
...
SET timescaledb.enable_uuid_compression = off;
INSERT INTO mixed_compressed SELECT i+2000, u FROM base_uuids;
INSERT INTO mixed_compressed SELECT i+2200, u FROM base_uuids;
INSERT INTO mixed_compressed SELECT i+2300 as i, NULL as u FROM base_uuids;
...
SET timescaledb.enable_uuid_compression = off;
INSERT INTO mixed_compressed SELECT i+3000, u FROM base_uuids;
INSERT INTO mixed_compressed SELECT i+3200, u FROM base_uuids;
INSERT INTO mixed_compressed SELECT i+3300 as i, NULL as u FROM base_uuids;
