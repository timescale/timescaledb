...
-- The purpose of this test is to exercise the AIC (Adaptive Integer Compressor) across
-- the supported datatypes and compression modalities. Ultimately this test
-- should provide a very good coverage of the AIC code.
--
...
SET timescaledb.enable_aic_compression = ON;
...
-- verify the existence of the compressed chunks using the AIC compressor
...
RESET timescaledb.enable_aic_compression;
