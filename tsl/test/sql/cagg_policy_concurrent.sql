...
SELECT add_continuous_aggregate_policy('mat_m1', '1 year'::interval, '30 days'::interval, '12 h'::interval);
SELECT add_continuous_aggregate_policy('mat_m1', '4 weeks'::interval, '-7 days'::interval, '12 h'::interval);
SELECT remove_continuous_aggregate_policy('mat_m1');
