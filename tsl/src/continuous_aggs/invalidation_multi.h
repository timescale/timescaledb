 ...
 * aggreate is stored here, including the bucket function and information
...
typedef struct MultiHypertableInvalidationState
{
	...
	Relation cagg_log;	/* Materialization invalidation log table */
...
extern void multi_invalidation_add_range(MultiHypertableInvalidationState *state,
										 int32 hypertable_id, int64 start, int64 end);
