...
typedef struct MultiInvalidationRangeEntry
{
	...
	Oid multirangetype;		  /* Multirange type for the partition column dimension type */
	Oid rangetype;			  /* Range type for the partition column dimension type */
...
{
	MemoryContext context; /* Memory context for processing */
