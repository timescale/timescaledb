...
void remote_invalidation_log_add_entry(const Hypertable *raw_ht, bool materialization,
...
extern void remote_invalidation_log_delete(int32 raw_hypertable_id, bool materialization);
