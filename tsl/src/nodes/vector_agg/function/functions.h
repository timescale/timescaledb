...
typedef struct
{
	 ...
	 */
	void (*agg_many_vector)(void *restrict agg_states, const uint16 *offsets, const uint64 *filter,
	 ...
	 */
	void (*agg_many_scalar)(void *restrict agg_states, const uint16 *offsets, const uint64 *filter,
