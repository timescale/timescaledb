...
typedef struct DecompressBatchState
{
	...
	/*
	 * Shared batch decompressor state. The values array of this state aliases
	 * compressed_columns below; it must be rebound after batch_array repallocs
	 * this struct (see batch_array_enlarge).
	 */
	BatchDecompressor decompressor;
