...
find_chunk_to_merge_into(Hypertable *ht, Chunk *current_chunk)
{
	...
	CompressionSettings *prev_comp_settings = ts_chunk_get_and_cache_compression_settings(previous_chunk);
									   ...
									   Chunk *mergable_chunk)
{
	...
	CompressionSettings *ht_settings =
		ts_chunk_get_and_cache_compression_settings(mergable_chunk);
...
tsl_compress_chunk_wrapper(Chunk *chunk, bool if_not_compressed, bool recompress)
{
	...
	{
		CompressionSettings *chunk_settings = ts_chunk_get_and_cache_compression_settings(chunk);
		bool valid_orderby_settings = chunk_settings && chunk_settings->fd.orderby;
		if (recompress)
		{
			CompressionSettings *ht_settings = ts_chunk_get_and_cache_hypertable_compression_settings(chunk);
