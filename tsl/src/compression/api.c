...
tsl_decompress_chunk(PG_FUNCTION_ARGS)
{
	...
	/*
	 * Post decompression regular DML can happen into this chunk. So, we drop any
	 * chunk_column_stats entries for this chunk now.
	 */
	ts_chunk_column_stats_delete_by_chunk_id(chunk_id);
